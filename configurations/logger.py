...
DEVELOPER_LOG_FORMAT = '{time:YYYY-MM-DD HH:mm:ss.SSS} | {level:<8} | {name}:{function}:{line} - {message}' HH:mm:ss.SSS} | {level:<8} | {name}:{function}:{line} - {message}'

USER_LOG_FORMAT = '{time:YYYY-MM-DD HH:mm:ss} | {level:<8} | {message}' HH:mm:ss} | {level:<8} | {message}'

SIMPLE_LOG_FORMAT = '{time:YYYY-MM-DD HH:mm:ss} | {level:<8} | {message}' HH:mm:ss} | {level:<8} | {message}'
...
simple_log_file_template = '{time:YYYY-MM-DD HH:mm:ss} | {level:<8} | {message}' HH:mm:ss} | {level:<8} | {message}'
